...
dataset, targets = zip(*(sample for _ in range(3000) for sample in generate_samples(random_state)))
...
print("Number of less than 4 letters after segmentation and correct is {0}".format(num_lt4c))
print("Number of less than 4 letters after segmentation and incorrect is {0}".format(num_lt4i))
print("Success rate: {0} %".format(num_correct / (num_correct + num_incorrect) * 100))
print("Success rate (with good segmentation): {0} %".format(num_correct / (num_correct + num_incorrect - num_lt4i) * 100))
